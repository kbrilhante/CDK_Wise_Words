...
function createHeading(parent, text) {
    ...
    h.className = "text-center border rounded-top-3 py-2 text-bg-secondary";
    h.textContent = text;
...
function createButtonSection(parent) {
    ...
    const col = createDiv(row);
    col.className = "col-auto mx-auto my-auto"; // used mx and my separate in case I want to change any alignment
    return col;
}
