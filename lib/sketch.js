...
function joinSession() {
    const inpStudentName = document.getElementById(INP_STUDENT_NAME_ID).value;
...
function startActivity() {
    ...
    getNewSentence().then(sentence => {
        setNewSentence(sentence).then(update => {
            console.log(update)
        })
    });
}

function showStudentSentence() {
